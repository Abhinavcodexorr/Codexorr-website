...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-x-hidden bg-slate-50 py-14 md:py-24 lg:py-32">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_65%_45%_at_50%_0%,rgba(236,72,153,0.06),transparent),radial-gradient(ellipse_45%_35%_at_5%_95%,rgba(167,139,250,0.06),transparent)]" />
