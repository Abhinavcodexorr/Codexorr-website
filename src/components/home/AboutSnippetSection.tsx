...
export function AboutSnippetSection() {
  return (
    <section className="relative overflow-x-hidden bg-slate-50 py-14 md:py-24 lg:py-32">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_80%_10%,rgba(167,139,250,0.10),transparent),radial-gradient(ellipse_50%_35%_at_10%_90%,rgba(34,211,238,0.10),transparent)]" />
      ...
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <HolographicCard intensity={5} glowColor="6,182,212">
              <div className="relative flex flex-col gap-5 p-6 md:p-10">
                ...
                <ul className="flex flex-col gap-3 text-sm text-slate-600">
                  {[
                    { color: "bg-cyan-500", text: "Embedded solution architects on every engagement." },
                    { color: "bg-violet-500", text: "Weekly demos — zero black-box delivery." },
