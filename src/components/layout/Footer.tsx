      ...
      <Container className="relative flex flex-col gap-12 md:flex-row md:items-start md:justify-between md:gap-16">
        <div className="mx-auto flex max-w-md flex-col items-center text-center md:mx-0 md:items-start md:text-left">
          <Link href="/"
            ...
            <Image src="/logo.png" alt="" width={32} height={32} className="h-8 w-8 mix-blend-screen" />
            <span className="font-heading text-lg font-bold tracking-tight text-white">CodeXorr</span>
          </Link>
          <p className="mt-3 text-sm leading-relaxed text-slate-400">
            Enterprise-grade engineering for ambitious teams — platforms that ship fast,
            scale cleanly, and feel unmistakably premium.
          </p>
          <a href="mailto:hello@codexorr.com"
