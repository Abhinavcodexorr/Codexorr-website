    ...
    const LOGO = "data:image/jpeg;base64,";
    ...
    function GradBtn({ children, href = "contact.html", className = "" }) {
      return (
        <motion.a href={href} whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}
          className={"inline-flex items-center justify-center font-mono text-sm px-6 py-3 rounded-xl text-white " + className}
          style={{ background: grad, boxShadow: "0 12px 34px rgba(108,71,255,0.32)" }}>
          {children}
        </motion.a>
      );
    }
    function GhostBtn({ children, href = "portfolio.html", className = "" }) {
      return (
        <motion.a href={href} whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}
          className={"inline-flex items-center justify-center font-mono text-sm px-6 py-3 rounded-xl " + className}
      ...
      return (
        <section className="py-20 relative isolate overflow-hidden" style={{ background: C.bg }}>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
              ...
              {SOLUTIONS.map((s, i) => (
                <Reveal key={s.key} delay={i * 0.05}>
                  <Tilt amount={8} glow className="h-full rounded-2xl p-5" style={{ background: C.surface, border: "1px solid " + C.line, boxShadow: "var(--soft)" }}>
                    <a href="solutions.html" className="block h-full">
            ...
            <Reveal className="mt-10 text-center"><GradBtn href="solutions.html">Explore All Solutions →</GradBtn></Reveal>
          </div>
        </section>
      );
    }
      ...
      return (
        <section className="py-20 relative isolate overflow-hidden" style={{ background: C.bg2 }}>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <Reveal className="mt-10 text-center"><GhostBtn href="services.html">View All Services →</GhostBtn></Reveal>
          </div>
        </section>
      );
    }
      ...
      return (
        <section className="py-20 relative isolate overflow-hidden" style={{ background: C.bg }}>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <Reveal className="mt-10 text-center"><GradBtn href="portfolio.html">View Full Portfolio →</GradBtn></Reveal>
          </div>
        </section>
      );
    }
        ...
        <motion.nav initial={{ y: -80, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, ease: EASE }}
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 h-16 flex items-center justify-between">
            <a href="index.html" className="flex items-center gap-3">
              <img src="logo (1).jpg" alt="Codexorr" className="w-8 h-8 rounded-lg object-cover"
            ...
            <div className="hidden md:flex items-center gap-7">
              {NAV.map((item, i) => (
                <motion.a key={item.key} href={item.href}
                  ...
                  onMouseLeave={(e) => (e.currentTarget.style.color = PAGE === item.key ? C.plasma : C.muted)}>{item.label}</motion.a>
              ))}
            </div>
            <div className="flex items-center gap-3">
              <GradBtn href="contact.html" className="hidden sm:inline-flex">Get In Touch</GradBtn>
            ...
            {open && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }}
                ...
                <div className="px-5 py-4 flex flex-col gap-4">
                  {NAV.map(item => <a key={item.key} href={item.href} onClick={() => setOpen(false)} className="font-mono text-sm" style={{ color: PAGE === item.key ? C.plasma : C.muted }}>{item.label}</a>)}
                  <GradBtn href="contact.html">Get In Touch</GradBtn>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <motion.div initial={reduce ? false : { opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.75 }}
                  ...
                  <GhostBtn href="portfolio.html">See Our Work</GhostBtn>
                </motion.div>
              </div>
        ...
        <section id="services" className="py-24 relative isolate overflow-hidden" style={{ background: C.bg2 }}>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <Reveal delay={0.1} className="mt-12 text-center rounded-3xl p-8" style={{ background: grad, boxShadow: "var(--soft-lg)" }}>
              ...
              <a href="contact.html" className="inline-flex font-mono text-sm px-6 py-3 rounded-xl" style={{ background: "#fff", color: C.plasma, boxShadow: "0 10px 30px rgba(0,0,0,0.18)" }}>Book 30 Min C-Level Consultation</a>
            </Reveal>
          </div>
        </section>
      );
                ...
                <AnimatePresence mode="wait">
                  <motion.div key={active} initial={reduce ? false : { opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} exit={reduce ? {} : { opacity: 0, x: -24 }} transition={{ duration: 0.4, ease: EASE }}
                    ...
                    <div className="p-7 sm:p-9">
                      ...
                      <div className="mt-7"><GhostBtn href="contact.html">Download Case Study â†“</GhostBtn></div>
                    </div>
                  </motion.div>
                </AnimatePresence>
              </div>
              ...
              {INDUSTRIES.map((it, i) => (
                <Reveal key={it.name} delay={(i % 5) * 0.05}>
                  <Tilt amount={8} glow className="h-full rounded-2xl p-5" style={{ background: C.surface, border: "1px solid " + C.line, boxShadow: "var(--soft)" }}>
                    ...
                    <a href="contact.html" className="font-mono text-xs" style={{ color: C.plasma }}>Live Demo â†’</a>
                  </Tilt>
                </Reveal>
              ))}
            </div>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8">
            ...
            <Reveal delay={0.2} className="mt-10 text-center rounded-2xl p-6" style={{ background: C.surface, border: "1px solid " + C.line }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <GhostBtn href="contact.html">Connect on Whatsapp</GhostBtn>
              </div>
            </Reveal>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl px-5 sm:px-8 text-center">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-3xl p-10 sm:p-14" style={{ background: grad, boxShadow: "var(--soft-lg)" }}>
                ...
                <div className="mt-8"><a href="contact.html" className="inline-flex font-mono text-sm px-7 py-3.5 rounded-xl" style={{ background: "#fff", color: C.plasma, boxShadow: "0 14px 40px rgba(0,0,0,0.2)" }}>Let's Build Together â†’</a></div>
              </div>
            </Reveal>
          </div>
        </section>
          ...
          <div className="relative mx-auto max-w-6xl px-5 sm:px-8" style={{ zIndex: 2 }}>
            <Reveal className="text-center">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="contact.html" className="font-mono text-sm px-7 py-3.5 rounded-xl" style={{ background: "#fff", color: C.plasma, boxShadow: "0 14px 40px rgba(0,0,0,0.25)" }}>Let's Build Together â†’</a>
                <a href="contact.html" className="font-mono text-sm px-7 py-3.5 rounded-xl text-white" style={{ border: "1px solid rgba(255,255,255,0.6)", background: "rgba(255,255,255,0.1)" }}>Connect on Whatsapp</a>
              </div>
            </Reveal>
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-10">
              <Reveal className="col-span-2">
                <div className="flex items-center gap-3 mb-4">
                  <img src={LOGO} alt="Codexorr" className="w-8 h-8 rounded-lg object-cover" style={{ border: "1px solid rgba(255,255,255,0.15)" }} />
                ...
                <a href="contact.html" className="inline-flex mt-5 font-mono text-sm px-5 py-2.5 rounded-xl text-white" style={{ background: grad }}>Lets Connect</a>
              </Reveal>
    ...
    createRoot(document.getElementById("root")).render(<Codexorr />);
